...
const LogoComponent = () => (
  <svg className={styles.container}>
    ...
    <circle className={styles.circle} cx="28.7" cy="29" r="27.3"/>
    <circle className={styles.circle} cx="28.7" cy="29" r="27.3"/>
    <path className={styles.st1} d="M38.4,24.6v14.2c0,0.2,0,0.4-0.1,0.6c-0.1,0.2-0.3,0.3-0.6,0.3h-1.6c-0.3,0-0.6-0.1-0.6-0.3
      ...
      "/>
    <path className={styles.st1} d="M18,22L18,22c-0.1-0.2-0.3-0.4-0.6-0.4h-1.7c-0.2,0-0.4,0.1-0.5,0.2C15,22,15,22.2,15,22.4l0,0.9
